...
function InputOTPSeparator({ ...props }: React.ComponentProps<'div'>) {
  return (
    // biome-ignore lint/a11y/useFocusableInteractive: dont mess with lib code
    // biome-ignore lint/a11y/useSemanticElements: dont mess with lib code
    // biome-ignore lint/a11y/useAriaPropsForRole: dont mess with lib code
